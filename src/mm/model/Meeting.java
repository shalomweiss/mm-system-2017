...
public class Meeting {
	...
	public enum meetingStatus {
		PENDING(0), APPROVED(1), COMPLETE(2), DECLINED(3), CANCELED(4);
		private final int value;
	...
	public String toString() {
		return "Meeting [meetingId=" + meetingId + ", pairId=" + pairId + ", mentorId=" + mentorId + ", menteeId="
				+ menteeId + ", note=" + note + ", status=" + status + ", menteeReport=" + menteeReport
				+ ", mentorReport=" + mentorReport + ", menteePrivateReport=" + menteePrivateReport
				+ ", mentorPrivateReport=" + mentorPrivateReport + ", meetingType=" + meetingType + ", subject="
				+ subject + ", location=" + location + ", date=" + date + ", startingDate=" + startingDate
