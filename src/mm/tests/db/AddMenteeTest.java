...
public class AddMenteeTest {
	...
	public static void main(String[] args) throws SQLException {
		...
		Mentee m1 = new Mentee(0, "badie", "bido", "bido@gmail.com", "125", "blabla", 1, "Haifa", "pic", "okay", true,
				userType.MENTEE, (float) 2, "Graduated", "University of Haifa", (float) 85.5, "Computer Science",
				"Engineering", true, "file", "file");
		...
		Mentee m3 = new Mentee(0, "areen", "areen", "areen@gmail.com", "125", "blabla", 1, "Haifa", "pic", "okay", true,
				userType.MENTEE, (float) 3, "not yet", "University of Haifa", (float) 98.8, "whatever", "whatever",
				true, "file", "file");
