...
public class TsofenT extends User{
	public TsofenT(int id, String firstName, String lastName, String email, String phoneNumber, String password,
			int gender, String address, String note, boolean profilePicture,boolean active, userType type, int areaId, String area, int cityId, String city, Date date, String personalId) {
